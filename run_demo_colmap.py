...
if __name__ == '__main__':
    ...
    parser.add_argument("--conf_path", type=str, default='configs/demo.conf', help='path of configure file')
    ...
    precomputed_data_path = os.path.join(data_path, 'data.pth')
    ...
    if use_precomputed_data and os.path.exists(precomputed_data_path):
        ...
        # run metric3dv2
        depth_maps_list, normal_maps_list = extract_mono_geo_demo(img_name_list, color_images_list, intrinsics_list)
    ...
    conf.put('dataset.mesh_pre_align', True)
