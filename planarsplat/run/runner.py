...
if __name__ == '__main__':
    ...
    parser.add_argument('--tag', type=str, default='-1', help='If set, taken to be the scan id.')
    ...
    # process tag if needed
    tag = cfg.get_string('dataset.tag', default='-1')
    if tag == '-1':
        assert args.tag != '-1', "tag should be given!"
        cfg.put('dataset.tag', args.tag)
