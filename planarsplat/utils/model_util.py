...
def split_planes_via_mask(
    split_x_mask, split_y_mask, split_xy_mask, 
    plane_xAxis, plane_yAxis, 
    plane_center, plane_radii_xy_p, plane_radii_xy_n, 
    plane_rot_q_normal_wxy, plane_rot_q_xyAxis_w, plane_rot_q_xyAxis_z, rot_delta
):
    new_plane_center = []
