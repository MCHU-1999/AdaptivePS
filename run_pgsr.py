...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--out_path", type=str, default='planarSplat_ExpRes/PGSR', help='path of output dir')
    parser.add_argument("--conf_path", type=str, default='configs/pgsr_as_prior.conf', help='path of configure file')
    ...
    precomputed_data_path = os.path.join(data_path, 'PGSR_precomputed.pth')
