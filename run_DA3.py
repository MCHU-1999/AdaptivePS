...
if __name__ == '__main__':
    ...
    parser.add_argument("-o", "--out_path", type=str, default='planarSplat_ExpRes/DA3', help='path of output dir')
    parser.add_argument("--conf_path", type=str, default='configs/DA3.conf', help='path of configure file')
    # parser.add_argument("--conf_path", type=str, default='configs/DA3_scaledup.conf', help='path of configure file')
    ...
    # scaled_depth_dir = os.path.join(data_path, 'DA3_scaled_depth')
    # os.makedirs(scaled_depth_dir, exist_ok=True)

    out_path = args.out_path
    os.makedirs(out_path, exist_ok=True)
    precomputed_data_path = os.path.join(data_path, 'DA3_precomputed.pth')
